...
func main() {
	...
	User := g.GenerateModel("user",
		...
		gen.FieldRelate(field.HasMany, "Address", Address, &field.RelateConfig{GORMTag: field.GormTag{"foreignKey": []string{"UID"}, "references": []string{"ID"}}}),
	...
	Address = g.GenerateModel("address",
		append(
			fieldOpts,
			gen.FieldRelate(field.BelongsTo, "User", User, &field.RelateConfig{GORMTag: field.GormTag{"foreignKey": []string{"Address"}, "references": []string{"ID"}}}),
		)...,
	)
